...
def remember_player(name):
    """Remember a player in this browser's current Streamlit session."""
    st.session_state["player_name"] = name


def restore_player(players):
    """Keep session identity only while the player belongs to this game."""
...
# Player identity must never be part of the shareable URL. Remove the legacy
# parameter from links created by the previous version of the app.
if "player" in st.query_params:
    del st.query_params["player"]
